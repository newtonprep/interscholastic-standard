...
1. **Publish the protocol:** make a versioned text available for reading, copying, and potentially adaptation.
2. **Maintain the official standard:** control revisions, interpretations, and the authoritative version.
3. **Administer conformance:** accept program commitments, verify evidence, keep a registry, and apply remedies with review and appeals.
4. **Handle officials' issues:** designate a counterparty responsible for payment procedures, complaints about treatment of officials, and enforceable corrective action.

An open copyright license addresses the first function. The other functions require governance rules, adoption agreements, staffing, and operational capacity. The protocol could be openly licensed while a separate body controls the official version and conformance designation.
...
## Decisions before publication or launch

- Identify the copyright holder and choose a license for the written standard; consider CC BY 4.0 for text, while reserving a distinct name or conformance mark for authorized use.
- Define who can adopt the standard, which version applies, how revisions take effect, and how exceptions are recorded.
- Define who owes officials' fees, payment deadlines, complaint intake, investigation, sanctions, appeal rights, and data retention.
- Define board seats, conflicts of interest, administrator performance measures, and the right to replace an administrator.
- Seek feedback from affected schools, officiating organizations, and prospective home-school adopters before claiming their support.

## Primary references

- [Texas Secretary of State: public benefit corporations](https://www.sos.state.tx.us/corp/formationfaqs.shtml#PBC)
- [Texas Secretary of State: nonprofit formation](https://www.sos.state.tx.us/corp/instructions/202.shtml)
- [Texas Secretary of State: nonprofit and tax-exemption distinctions](https://www.sos.state.tx.us/corp/nonprofit_org.shtml)
